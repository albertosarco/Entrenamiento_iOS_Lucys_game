...
class GamesListCollectionView: UICollectionView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func awakeFromNib() {
        ...
        self.register(UINib(nibName: GamesListItemCVCell.nibName, bundle: nil),
                      forCellWithReuseIdentifier: GamesListItemCVCell.nibName)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: GamesListItemCVCell.nibName, for: indexPath)
...
class GamesListItemCVCell: UICollectionViewCellAutoSize {
    
    fileprivate static let nibName: String = "GamesListItem"
